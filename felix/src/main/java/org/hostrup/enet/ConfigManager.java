...
public class ConfigManager {
    ...
    /**
     * Loads the MQTT configuration from the properties file.
     */
    private void loadConfig() {
        ...
        try (FileInputStream in = new FileInputStream(CONFIG_FILE)) {
            ...
            // Properties file might not exist yet, which is fine
        }
    }

    /**
     * Saves the MQTT configuration and triggers an MQTT reconnection.
     */
